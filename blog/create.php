...
<html lang="en">
    ...
    <script>
        function checkpass(){
            ...
            if(inputpass.trim() === ''){
                document.getElementById('err').innerHTML = '<br><br>Password cannot be NULL<br>';  
            } else if (isNaN(inputpass.trim())){         
                document.getElementById('err').innerHTML = '<br><br>Your password is not a PIN!<br>';               
            } else {
        ...
        <section class="page-section bg-blvck" id="services">
            <div class="container text-porcelain">
                ...
                <div class="row">
                    <div class="col-md">
                    <center>
                    <h2 class="section-heading text-uppercase">Blog Creation </h2>
                        <h3 class="section-subheading text-darkporcelain">Seems easy enough right?</h3>
                    </center>
                    </div>
                </div>
                    ...
                    <div class="col-lg ">
                        <div class="text-porcelain ">
                            ...
                            <div class="m-4">
                                ...
                                Create PIN: <input type="password" id='pass' name="password"><br><br>
                                <input type="button" onclick="checkpass()" class="btn btn-dark" value="Add Post">     
